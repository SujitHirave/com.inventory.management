...
import com.inventory.management.configuration.JwtUtil;
...
public class JwtService implements UserDetailsService {
    ...
    private Set getAuthority(AppUser user) {
        ...
        ((Iterable) user.getRole()).forEach(role -> {
            authorities.add(new SimpleGrantedAuthority("ROLE_" + ((Role) role).getRoleName()));
        });
        return authorities;
    }
